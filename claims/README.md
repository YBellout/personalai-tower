...
chat holds. It adds its claim first, and removes it when it closes out its session or
when the control room has merged the story, whichever comes first. A closed chat holds nothing. A claim older than 24 hours with no report behind it is stale: the audit flags it,
